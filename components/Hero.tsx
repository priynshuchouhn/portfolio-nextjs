        ...
        <div className='pb-20 pt-36'>
            ...
            <div className="flex justify-center my-20 relative z-10">
                <div className="flex flex-col justify-center items-center max-w-[89vw] md:max-w-2xl lg:max-w-[60vw]">
                    <h2 className='uppercase tracking-widest text-xs text-center text-blue-100 max-w-80'>Dyanmic Web Magic With Next.js</h2>
                    ...
                    <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
                        Hi, I&apos;m Priyanshu, a FullStack Engineer based in India 
                    </p>
